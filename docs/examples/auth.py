...
async def ldap_authenticate_example():
    ...
    e.g. PLAIN or Simple Authentication and Security Layer (SASL) EXTERNAL, GSSAPI, OAUTHBEARER
    """
    ...
    async with ldap.Connection('ldap://localhost:389') as conn:
        ...
        authzid = None
        token = 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIn0.dBjftJeZ4CVP-mB92K27uhbUJU1p1r_wW1gFWFOEjXk'  # noqa: S105
